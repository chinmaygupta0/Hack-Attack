...
const features = [
    ...
    },
    {
        id: 2,
        title: 'Live Coding',
        description: 'Code together in real-time with syntax highlighting and auto-completion.',
        icon: FaCode,
    },
    {
        id: 3,
...
const testimonials = [
    {
        ...
        content: 'CollabHub has revolutionized our team\'s workflow. It\'s an indispensable tool for our daily operations.',
    },
    {
        id: 2,
        name: 'Jane Smith',
        role: 'Product Manager at InnovateTech',
        content: 'The real-time collaboration features have significantly improved our productivity and creativity.',
    },
    {
        id: 3,
        name: 'Mike Johnson',
        role: 'Lead Developer at CodeMasters',
        content: 'As a remote team, CollabHub has been a game-changer for our collaborative coding sessions.',
    },
    {
        id: 4,
        name: 'Emily Davis',
        role: 'UX Designer at PixelPerfect',
        content: 'CollabHub has made cross-functional collaboration seamless and has enhanced our design feedback process.',
    },
    {
        id: 5,
        name: 'Carlos Rodriguez',
        role: 'Marketing Director at BrandBuilders',
        content: 'Thanks to CollabHub, our marketing team can easily align with other departments. It has streamlined our campaigns.',
    },
    {
        id: 6,
        name: 'Samantha Lee',
        role: 'CEO at Visionary Ventures',
        content: 'CollabHub has empowered our entire organization to work more efficiently, regardless of location. A must-have tool!',
    },
];
...
const faqs = [
    {
        ...
        answer: 'Yes, CollabHub is completely free for individual users and students. We believe in empowering creativity and collaboration at all levels.',
    },
    {
        id: 2,
        question: 'How does pricing work for institutions?',
        answer: 'For institutions, we offer custom pricing based on the size of your organization and specific needs. Please contact our sales team for a tailored quote.',
    },
    {
        id: 3,
        question: 'Can I use CollabHub with my existing tools?',
        answer: 'Yes, CollabHub integrates seamlessly with many popular tools and platforms. We\'re constantly expanding our integration options.',
    },
    {
        id: 4,
    ...
    },
    {
        ...
        answer: 'There\'s no limit to the number of collaborators on a project. Whether you\'re working in a small team or a large organization, CollabHub scales to meet your needs.',
    },
    {
        id: 6,
        question: 'Do you offer training or onboarding for new users?',
        answer: 'Yes, we provide comprehensive documentation, video tutorials, and webinars to help new users get started. For institutions, we also offer personalized onboarding sessions.',
    },
];
            ...
            <main className="relative">
                    ...
                    <div className="relative mx-auto max-w-7xl px-4 lg:px-8 sm:px-6">
                        ...
                        >
                            ...
                            <p className="mx-auto mb-8 max-w-3xl text-xl text-gray-300 md:text-2xl">
                                Experience the future of teamwork with our cutting-edge platform. Draw, code, and write
                ...
                <section className="py-20">
                    <div className="mx-auto max-w-7xl px-4 lg:px-8 sm:px-6">
                        <h2 className="mb-12 text-center text-3xl font-extrabold">Trusted by Innovative Companies</h2>
                ...
                <section id="features" className="py-20">
                    <div className="mx-auto max-w-7xl px-4 lg:px-8 sm:px-6">
                        <h2 className="mb-16 text-center text-4xl font-extrabold">Powerful Features for Seamless
                            Collaboration
                        </h2>
                        <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
                            {features.map((feature, index) => (
                                ...
                                >
                                    ...
                                    <h3 className="mb-4 text-center text-2xl font-semibold">{feature.title}</h3>
                ...
                <section className="py-20">
                    <div className="mx-auto max-w-7xl px-4 lg:px-8 sm:px-6">
                        <h2 className="mb-16 text-center text-4xl font-extrabold">What Our Users Say</h2>
              ...
              <span className="bg-gradient-to-r from-blue-400 to-purple-600 bg-clip-text text-transparent">
                ...
                <section className="py-20">
                    <div className="mx-auto max-w-7xl px-4 lg:px-8 sm:px-6">
                        <h2 className="mb-16 text-center text-4xl font-extrabold">Frequently Asked Questions</h2>
                ...
                <section className="py-20">
                    <div className="mx-auto max-w-7xl px-4 text-center lg:px-8 sm:px-6">
                        <h2 className="mb-8 bg-gradient-to-r from-blue-400 to-purple-600 bg-clip-text text-4xl font-extrabold text-transparent">Ready to Transform Your Team's Collaboration?</h2>
                        <p className="mx-auto mb-12 max-w-3xl text-xl">Join thousands of teams already using CollabHub
